...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
            <a class="nav-link " href="index.php?page=edit_about" >
                    <i class="	fas fa-user-alt"></i>
                    <span>About</span>
                </a>

                <a class="nav-link " href="index.php?page=tampil_produk" >
                     <i class="fas fa-box"></i>
                    <span>Produk</span>
                </a>
                
                <a class="nav-link " href="index.php?page=tampil_berita" >
                    <i class="fas fa-newspaper"></i>
                    <span>Berita</span>
                </a>

                <a class="nav-link " href="index.php?page=tampil_galeri" >
                    <i class="fas fa-photo-video"></i>
                    <span>Gallery</span>
                </a>

                <a class="nav-link " href="index.php?page=edit_contact" >
